      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex gap-5">
            <Link to="/">
              <img
                className="w-12 h-12 pt-1.5 rounded-full"
                src="/images/zahid.jpg"
                alt="logo"
              />
            </Link>
            <Link
              className="text-2xl font-extrabold mt-1.5 text-yellow-400"
              to="/"
            >
              Jahidul Islam
            </Link>
              ...
              {navLinks.map((link) => (
                <li key={link.name}>
                  <button
                    ...
                    className="py-2 px-3 text-gray-300 hover:text-white hover:underline hover:underline-offset-4 transition duration-300"
                  >
                    {link.name}
                  </button>
                </li>
